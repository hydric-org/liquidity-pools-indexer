...
describe("GLiquidAlgebraFactory", () => {
  ...
  let poolEvent: GLiquidAlgebraFactory_Pool_event;
  let customPoolEvent: GLiquidAlgebraFactory_CustomPool_event;
  ...
  beforeEach(() => {
    ...
    poolEvent = GLiquidAlgebraFactory.Pool.createMockEvent({
      mockEventData: {
        chainId: network,
      },
    ...
    customPoolEvent = GLiquidAlgebraFactory.CustomPool.createMockEvent({
      mockEventData: {
        chainId: network,
      },
      pool: "0x0000000000000000000000000000000000000221",
  ...
  describe("Pool Handler", () => {
    ...
    it("should pass GLIQUID_ALGEBRA as protocol to handler", async () => {
    ...
    it("should pass V1_2_1 as version to handler", async () => {
      ...
      assert.equal(passedVersion, AlgebraVersion.V1_2_1);
    });
