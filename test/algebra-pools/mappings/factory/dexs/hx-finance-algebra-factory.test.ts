...
describe("HxFinanceAlgebraFactory", () => {
  ...
  let poolEvent: HxFinanceAlgebraFactory_Pool_event;
  let customPoolEvent: HxFinanceAlgebraFactory_CustomPool_event;
  ...
  beforeEach(() => {
    ...
    poolEvent = HxFinanceAlgebraFactory.Pool.createMockEvent({
      mockEventData: {
        chainId: network,
      },
    ...
    customPoolEvent = HxFinanceAlgebraFactory.CustomPool.createMockEvent({
      mockEventData: {
        chainId: network,
      },
      pool: "0x0000000000000000000000000000000000000221",
  ...
  describe("Pool Handler", () => {
    ...
    it("should pass HX_FINANCE_ALGEBRA as protocol to handler", async () => {
