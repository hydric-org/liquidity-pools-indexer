...
import { handleAlgebraPoolBurn } from "../../../../src/algebra-style-pools/mappings/pool/algebra-pool-burn";
...
describe("AlgebraPoolBurn", () => {
  ...
  // TODO: re-enable this test when the defi pool data is Implemented for algebra pools
