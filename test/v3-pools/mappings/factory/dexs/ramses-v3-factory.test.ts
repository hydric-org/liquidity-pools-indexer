...
import { RamsesV3Factory_PoolCreated_event } from "generated";
import { MockDb, RamsesV3Factory } from "generated/src/TestHelpers.gen";
...
describe("RamsesV3Factory", () => {
  ...
  describe("Pool Handler", () => {
    ...
    it("should pass RAMSES_V3 as protocol to handler", async () => {
      ...
      assert.equal(passedProtocol, SupportedProtocol.RAMSES_V3);
    });
