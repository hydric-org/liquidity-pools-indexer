...
export abstract class TickMath {
  ...
  public static MIN_POOL_SQRT_RATIO: bigint = BigInt("4295128739");
  public static MAX_POOL_SQRT_RATIO: bigint = BigInt("1461446703485210103287273052203988822378723970342");
  ...
  public static getSqrtRatioAtTick(tick: number): bigint {
    ...
    return ratio / BigInt(2) ** BigInt(32) + (ratio % BigInt(2) ** BigInt(32) > BigInt(0) ? BigInt(1) : BigInt(0));
  }
}
